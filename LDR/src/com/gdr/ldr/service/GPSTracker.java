...
public class GPSTracker extends Service implements LocationListener {
                ...
                if (isNetworkEnabled) {
                    ...
                    if (locationManager != null) {
                        ...
                        if (location != null) {
                            ...
                            /*if(new Double(0.0).equals(latitude)||new Double(0.0).equals(longitude)){
                                showSettingsAlert();
                            }*/
                        }
                    }
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setPositiveButton(R.string.GPS_BUTTON_SETTING, new DialogInterface.OnClickListener() {
        ...
        alertDialog.setNegativeButton(R.string.GPS_BUTTON_CANCEL, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
            }
        });
